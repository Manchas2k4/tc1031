...
// =================================================================
template <class T>
int find_pivot(std::vector<T> &A, int low, int high) {
	int i;
...
// =================================================================
template <class T>
int make_partition(std::vector<T> &A, int low, int high, int pivot) {
	int i, j;
...
// =================================================================
template <class T>
void quick(std::vector<T> &A, int low, int high) {
	int pivot, pos;
...
// =================================================================
template <class T>
void quickSort(std::vector<T> &A, int size) {
	quick(A, 0, A.size() - 1);
}
